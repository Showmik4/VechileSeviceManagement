	...
	<div class="col-md-6 well">
		...
		?>
			<div class="col-md-3" style="border:1px solid #ccc; padding:10px; margin:23px; height:250px;">
				...
				<center><h5><?php echo $fetch['category']?></h5></center>
				<center><h5>&#8369;<?php echo number_format($fetch['cost'])?></h5></center>
				<br />
				<center><a href="purchase.php?product_id=<?php echo $fetch['id']?>" class="btn btn-warning"><span class="glyphicon glyphicon-shopping-cart"></span> Purchase</a></center>
			</div>
		<?php		
			}
		?>
